...
const ViewPurchaseTable = ({
  ...
  const initialDateLabel = today.toLocaleDateString("en-US", {
    year: "numeric",
    month: "long",
    day: "numeric",
  });
        ...
        <table className="min-w-full bg-white border-collapse text-p14 font-dm-sans font-medium">
          <thead>
            <tr className="bg-neutral-600 text-white text-left">
              <th className="p-2.5 rounded-tl-[8px] min-w-[150px]">
                Invoice No.
              </th>
              ...
              .map((purchase, index) => (
                ...
                >
                  ...
                  <td
                    ...
                    style={{ width: "123px", height: "43px" }}
                  >
                    {purchase.farmer_id ? purchase.farmer_id.full_name : "-"}
                  </td>
                  <td
                    className="px-2 py-0"
                    style={{ width: "123px", height: "43px" }}
                  >{`${formatDecimal(purchase.amount_of_copra_purchased)} kg.`}</td>
                  <td
                    className="px-2 py-0"
                    style={{ width: "123px", height: "43px" }}
                  >{`${formatDecimal(purchase.moisture_test_details, 0)}%`}</td>
                  <td
                    className="px-2 py-0"
                    style={{ width: "123px", height: "43px" }}
                  >{`Php ${formatDecimal(purchase.sales_unit_price)}`}</td>
                  <td
                    className="px-2 py-0"
                    style={{ width: "123px", height: "43px" }}
                  >{`Php ${formatDecimal(purchase.total_purchase_price)}`}</td>
                  <td
              ...
              (_, index) => (
                <tr
                  ...
                  className={getRowClassName(
                    indexOfFirstRecord + currentRecords.length + index
                  )}
                  style={{ width: "123px", height: "43px" }}
                >
